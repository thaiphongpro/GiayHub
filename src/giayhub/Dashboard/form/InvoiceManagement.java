...
public class InvoiceManagement extends javax.swing.JPanel {
    ...
    private DefaultTableModel dtmThongTinHDCT = new DefaultTableModel();

    int a = -1; // Hoa Don
    int b = -1; // Khach Hang
    int c = -1; // Hoa Don Chi Tiet
    int d = -1; // Thong Tin HDCT
    ...
    public InvoiceManagement() {
        ...
        dtmThongTinHDCT = (DefaultTableModel) tbThongTinHDCT.getModel();
    ...
    public void showDataTableThongTinHoaDonChiTiet(List<OrderDetails> lists) {
        dtmThongTinHDCT.setRowCount(0);
        for (OrderDetails orderDetails : lists) {
            dtmThongTinHDCT.addRow(new Object[]{
                orderDetails.getOrderID(),
    ...
    private void initComponents() {
        ...
        tbThongTinHDCT = new javax.swing.JTable();
        ...
        lblTongHoaDon.setText("no value");
        ...
        tbHoaDonChiTiet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã HĐCT", "Mã ĐH", "Mã SP", "Tên SP", "Số Lượng", "Đơn Giá", "Tổng Tiền"
            }
        ));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Thông Tin Hóa Đơn Chi Tiết"));
        ...
        jScrollPane4.setViewportView(tbThongTinHDCT);
        ...
        lblTongTien.setFont(new java.awt.Font("Inter 24pt", 1, 14)); // NOI18N
        lblTongTien.setForeground(new java.awt.Color(255, 0, 0));
        lblTongTien.setText("50 tỷ");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnXuatHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void tbHoaDonChiTietMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbHoaDonChiTietMouseClicked
        c = tbHoaDonChiTiet.getSelectedRow();
        if (c != -1) {
            int orderID = Integer.parseInt(dtmHoaDonChiTiet.getValueAt(c, 1) + "");

            List<OrderDetails> danhSach = serviceHoaDon.selectOrders(orderID); // OrderID được chọn

            lblTongTien.setText(serviceHoaDon.getTotalPrice(orderID) + "");

            showDataTableThongTinHoaDonChiTiet(danhSach);
        }
    ...
    private void btnXuatHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatHoaDonActionPerformed
        ...
        if (o == JOptionPane.YES_OPTION) {
            try {
                ...
                for (int j = 0; j < tbThongTinHDCT.getRowCount(); j++) {
                    int maSP = Integer.parseInt(dtmThongTinHDCT.getValueAt(j, 2) + "");
                    String tenSP = dtmThongTinHDCT.getValueAt(j, 3) + "";
                    int soLuong = Integer.parseInt(dtmThongTinHDCT.getValueAt(j, 4) + "");
                    double giaTien = Double.parseDouble(dtmThongTinHDCT.getValueAt(j, 5) + "");
                    double tongTien = Double.parseDouble(dtmThongTinHDCT.getValueAt(j, 6) + "");

                    fields.add(new FieldReportPayment(maSP, tenSP, soLuong, giaTien, tongTien));
                }

                a = tbHoaDon.getRowCount() - 1;
                d = tbThongTinHDCT.getRowCount() - 1;
                int maHoaDon = Integer.parseInt(dtmHoaDon.getValueAt(a, 0) + "");
                String khachHang = dtmThongTinHDCT.getValueAt(d, 1) + "";
                String ngayTao = String.valueOf(ngayHienTai);
                double tongTien = Double.parseDouble(lblTongTien.getText());
                double tienKhachDua = Double.parseDouble(lblTongTien.getText());
    ...
    private javax.swing.JTable tbThongTinHDCT;
